 ...
 */
@SuppressLint("AppCompatCustomView") public class LoadView extends ImageView {
  ...
  private void init() {
    ...
    Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.rskj_loading);
