...
public class LFRecyclerViewFooter extends LinearLayout {
  ...
  private void initView(Context context) {
    ...
    LinearLayout moreView = (LinearLayout) LayoutInflater.from(mContext)
        .inflate(R.layout.rskj_lfrecyclerview_footer, null);
    addView(moreView);
    moreView.setLayoutParams(
        new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
    lfrecyclerview_footer_state =
        (RelativeLayout) moreView.findViewById(R.id.lfrecyclerview_footer_state);
    ...
    lfrecyclerview_footer_loadview =
        (LoadView) moreView.findViewById(R.id.lfrecyclerview_footer_loadview);
  }
