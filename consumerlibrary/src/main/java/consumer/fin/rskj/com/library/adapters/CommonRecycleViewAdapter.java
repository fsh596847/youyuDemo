...
public abstract class CommonRecycleViewAdapter<T> extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    public CommonRecycleViewAdapter(RecyclerView view, List<T> list, int itemLayoutId){
        this.lists = list;
