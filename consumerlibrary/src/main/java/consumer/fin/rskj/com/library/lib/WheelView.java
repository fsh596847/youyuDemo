package consumer.fin.rskj.com.library.lib;
...
import consumer.fin.rskj.com.library.adapters.WheelAdapter;
import consumer.fin.rskj.com.library.listener.OnItemSelectedListener;
import consumer.fin.rskj.com.library.module.IPickerViewData;
...
public class WheelView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		try {
			...
			LogUtils.d("WheelView","出错了！adapter.getItemsCount() == 0，联动数据不匹配");
		}
		if (!isLoop) {//不循环的情况
	...
	private String getContentText(Object item) {
		...
		}else if(item instanceof KVItem){
			return ((KVItem) item).getValue();
		}
