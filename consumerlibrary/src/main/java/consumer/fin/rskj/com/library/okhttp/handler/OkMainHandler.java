package consumer.fin.rskj.com.library.okhttp.handler;
...
import consumer.fin.rskj.com.library.okhttp.bean.ProgressMessage;
...
import consumer.fin.rskj.com.library.okhttp.callback.CallbackOk;
import okhttp3.Call;
                ...
                case RESPONSE_CALLBACK://网络请求
                    ...
                    if(null != callMsg.callback){
                        ...
                        if(!BaseActivityLifecycleCallbacks.isActivityDestroyed(callMsg.requestTag)){
                            ...
                            } else if(callback instanceof  consumer.fin.rskj.com.library.okhttp.callback.Callback){
                                HttpInfo info = callMsg.info;
                                if(info.isSuccessful()){
                                    ((consumer.fin.rskj.com.library.okhttp.callback.Callback)callback).onSuccess(info);
                                }else{
                                    ((consumer.fin.rskj.com.library.okhttp.callback.Callback)callback).onFailure(info);
                                }
                            }
                        }
                    }
