...
public class CurrentBillActivity extends BaseActivity {
    ...
    private static final String TAG = "CurrentBillActivity";
    ...
    private BigDecimal total = new BigDecimal(0).setScale(2,BigDecimal.ROUND_HALF_UP);//全额还款

    private BigDecimal yqtotal = new BigDecimal(0).setScale(2,BigDecimal.ROUND_HALF_UP);//逾期总额
    ...
    public void init() {
        ...
        //        if (currentStatus) {
        //            topNavigationView2.setTitle("逾期还款");
        //        } else {
        //            topNavigationView2.setTitle("当前还款");
        //        }
        ...
        pAdapter.setOnItemClickListener(new BSBillAdapter.OnItemClickListener() {
            @Override
            public void OnItemClick(View view, BSBillAdapter.TViewHolder holder, int position) {

                if (currentStatus) {//逾期还款只能选择逾期先还款，不是逾期的话 只能全额还款
                    BystatdgeBillItem cb = itemList.get(position);
                    Log.d(TAG, "getStatus11 = " + cb.getStatus());
                    if (!"3".equals(cb.getStatus())) {//如果当前item 没有逾期，不能点击
    ...
    private void M100712(){
        ...
        requestParams.put("transCode", "M100712");//接口标识
    ...
    private void getBillDetail() {
        ...
        //M100705 贷款应还款信息查询
        requestParams.clear();
        requestParams.put("transCode", "M100705");//接口标识
        requestParams.put("channelNo", Constants.CHANNEL_NO);//渠道标识
        requestParams.put("clientToken", sharePrefer.getToken());//登录后token
        requestParams.put("legalPerNum", "00001");
        ...
        sendPostRequest(requestParams, new ResultCallBack() {
            ...
            public void onSuccess(String data) {
                ...
                try {
                    ...
                    //                    total.multiply(new BigDecimal(0));
                    //                    yqtotal.multiply(new BigDecimal(0));
                    ...
                    //total_all.setText("总计:"+yqtotal.setScale(2,BigDecimal.ROUND_HALF_UP));
    ...
    public void getDetail() {
        requestParams.clear();
        requestParams.put("transCode", "M100721");//接口标识
        requestParams.put("channelNo", Constants.CHANNEL_NO);//渠道标识
        requestParams.put("clientToken", sharePrefer.getToken());//登录后token
        requestParams.put("legalPerNum", "00001");
    ...
    private void calclatulate() {
        ...
        if (currentStatus) {
            ...
            //            total_all.setText("总计:"+total.setScale(2,BigDecimal.ROUND_HALF_UP));
            //            total_lixi.setText("(含利息:"+yq_lixi.setScale(2,BigDecimal.ROUND_HALF_UP));
            //            total_faxi.setText("罚息:"+yq_faxi.setScale(2,BigDecimal.ROUND_HALF_UP) + ")");
        }
