...
public class FaceActivity extends BaseActivity
    ...
    private void handleStart() {
        ...
        isHandleStart = true;
        // 开始动画
        Animation animationIN = AnimationUtils.loadAnimation(FaceActivity.this, R.anim.face_liveness_rightin);
        Animation animationOut = AnimationUtils.loadAnimation(FaceActivity.this, R.anim.face_liveness_leftout);
