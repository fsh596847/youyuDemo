...
//    public static final String BASE_URL_STRAT = "http://10.2.11.174:8090";
  ...
  public static final String LOGIN_URL = "http://test.rskj99.com/rskj-core-api/member/login";
    ...
    public static final String TRANS_CODE_UPLOAD_FRONT_PICTURE = "M120003";// 客户身份证正面照片上传
    public static final String TRANS_CODE_UPLOAD_BACK_PICTURE = "M120004";// 客户身份证fan面照片上传

    public static final String TRANS_CODE_UPLOAD_BASIC_INFO = "M010310";// 客户基本信息上传接口标识
    public static final String TRANS_CODE_UPLOAD_ALL_CONTANTS_INFO = "S000010";// 客户通讯录信息上传接口标识
    public static final String TRANS_CODE_QUERY_H5_URL="S300002";// 查询H5URL接口
    public static final String TRANS_CODE__CHECK_BANKCARD_IS_QINGYUAN="S200005";// 判断是否为清远农商的银行卡接口
    public static final String TRANS_CODE_FACE_CHECK = "M100107";// 活体检测接口
    public static final String TRANS_CODE_BANK_CARD_CHECK_THREE = "M100109";// 银行卡号验证三接口
