 ...
 * 人脸识别结果页
 */
public class FaceResultActivity extends BaseActivity implements
...
//			}
			...
			mResultImageView.setImageResource(isSuccess ? R.mipmap.face_result_success : R.mipmap.face_result_fail);
			if (isSuccess) {
