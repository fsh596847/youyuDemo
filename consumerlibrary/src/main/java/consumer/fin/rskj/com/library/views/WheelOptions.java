...
import consumer.fin.rskj.com.library.adapters.ArrayWheelAdapter;
import consumer.fin.rskj.com.library.lib.WheelView;
...
public class WheelOptions<T> {
    ...
    private ArrayList<T> N_mOptions2Items;
    private ArrayList<ArrayList<ArrayList<T>>> mOptions3Items;
    private ArrayList<T> N_mOptions3Items;
    ...
    //不联动情况下
    public void setNPicker(ArrayList<T> options1Items,
