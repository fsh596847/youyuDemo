...
public class HttpInterceptor {
     ...
     */
    public static consumer.fin.rskj.com.library.okhttp.interceptor.ResultInterceptor ResultInterceptor = new ResultInterceptor() {
        @Override
     ...
     */
    public static consumer.fin.rskj.com.library.okhttp.interceptor.ExceptionInterceptor ExceptionInterceptor = new ExceptionInterceptor() {
        @Override
        public HttpInfo intercept(HttpInfo info) throws Exception {
