...
public class WebViewActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static final String TAG = "WebViewActivity01";
    ...
    private TextView right_btn;//头部右侧按钮
    Drawable rightImage;
    ...
    private String showUserCenter = "-1";//是否显示个人中心
...
//            showNetDialog(backCallBack);
    ...
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onMainEventBus(NetMessage msg) {
        //提前加载页面，然后跳转
...
//                    CharSequence pnotfound2 = "无法打开";
//                    LogUtils.d(TAG,"title === " + title);
//                    if (title.contains(pnotfound) || title.contains(pnotfound2) ) {
//                        view.stopLoading();
//                        view.loadUrl("file:///android_asset/error.html");
//                    }else {
//                        mTitleTv.setText(title);
    ...
    private void registerAction() {
        ...
        mWebview.registerHandler("registerAction", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                ...
                map.put("fundId", /*"5a32c168fc3345ef8bcfd41c6192789e"*//*sharePrefer.getFundId15()*/fundId);
...
//                LogUtils.d(TAG,"登录失效 = " + data);
//                Intent intent = new Intent();
//                intent.setAction("rskj.intent.action.login");
//                startActivity(intent);
//                finish();
