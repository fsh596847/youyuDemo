 ...
 * 基本信息-联系人信息页面
 */
public class HXBasicLinkInfoActivity extends HXBaseActivity implements
        OnClickListener {

    protected static final String TAG = "HXBasicLinkInfoActivity";
...
//				Toast.makeText(HXBasicLinkInfoActivity.this,"信息上传失败!",1).show();
                    CustomDialog.Builder builder = new CustomDialog.Builder(
                            HXBasicLinkInfoActivity.this);
                ...
                case Contants.MSG_UPLOAD_CUST_INFO_SUCCESS:
                    //Toast.makeText(HXBasicLinkInfoActivity.this, "信息上传成功!", Toast.LENGTH_SHORT).show();

                    //调用工作流
                    setProgress();


//                    Intent intent = new Intent(HXBasicLinkInfoActivity.this, HXDealBankCardActivity.class);
...
//		edit.commit();
    ...
    private void initViews() {
        ...
        relatipnships.add("兄妹");
        relatipnships.add("其他亲属");
...
//	        		 LoggerUtil.debug("chooseOptions  text"+text);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.left_btn:
                // 返回
                HXBasicLinkInfoActivity.this.finish();
                break;
...
//				mHandler.sendMessage(msg);
                    Toast.makeText(HXBasicLinkInfoActivity.this, "联系人姓名不能为空!", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//				msg.obj = "联系人电话不能为空!";
//				mHandler.sendMessage(msg);
                    Toast.makeText(HXBasicLinkInfoActivity.this, "联系人电话不能为空!", Toast.LENGTH_SHORT).show();
                    return;
                }
                //判断手机号是否合法
...
//				mHandler.sendMessage(msg);
                    Toast.makeText(HXBasicLinkInfoActivity.this, "请输入11位合法手机号码!", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//				msg.obj = "联系人关系不能为空!";
//				mHandler.sendMessage(msg);
                    Toast.makeText(HXBasicLinkInfoActivity.this, "联系人关系不能为空!", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//				mHandler.sendMessage(msg);
                    Toast.makeText(HXBasicLinkInfoActivity.this, "联系人姓名不能与借款人姓名一致!", Toast.LENGTH_SHORT).show();
                    return;
                }
                String loginNumber = getSharePrefer().getPhone();
                if (linkPhone.equals(loginNumber)) {
//				Message msg = new Message();
//				msg.what = Contants.MSG_UPLOAD_CUST_INFO_FAILURE;
//				msg.obj = "联系人电话不能与登录手机号一致!";
//				mHandler.sendMessage(msg);
                    Toast.makeText(HXBasicLinkInfoActivity.this, "联系人电话不能与登录手机号一致!", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void submitInfo(String selfName, String selfIdcard, String selfAddress, String selfRepaySum,
        ...
        params.addBodyParameter("custMobile", getSharePrefer().getPhone());// 登录手机号
...
//		HttpUtils dataHttp = new HttpUtils("60 * 1000");
        httpRequest(Contants.REQUEST_URL, params, new ResultCallBack() {
            ...
            public void onError(String returnCode, String msg) {
                ...
                mSubmitBtn.setClickable(true);
                mSubmitBtn.setBackgroundResource(R.drawable.hxcommon_btn_normal_bg);
                //Toast.makeText(HXBasicLinkInfoActivity.this,msg, Toast.LENGTH_SHORT).show();
...
//				mHandler.handleMessage(errorMsg);
    ...
    private void setProgress() {
        ...
        params.addBodyParameter("userId", getSharePrefer().getUserId());
        params.addBodyParameter("custNum", getSharePrefer().getCustNum());
        params.addBodyParameter("productId", getSharePrefer().getProductId());

        LogUtils.Log(TAG,"M000159 === getTokenKey = " + getSharePrefer().getTokenKey());

        params.addBodyParameter("tokenKey",getSharePrefer().getTokenKey());
        ...
        httpRequest(Contants.REQUEST_URL, params, new ResultCallBack() {
            ...
            public void onSuccess(String data) {
                ...
                LogUtils.Log(TAG,"M000159 === data = " + data);
                ...
                if("00".equals(flag)){
                    Intent intent = new Intent(HXBasicLinkInfoActivity.this,HXResultingActivity.class);
                    startActivity(intent);
                }
...
//                    startActivity(intent);
                ...
                if ("M000160".equals(returnCode)) {
                    Intent intent = new Intent(HXBasicLinkInfoActivity.this, HXResultActivity.class);
            ...
            public void onError(String returnCode, String returnMsg) {
                // TODO Auto-generated method stub
                mDialog.cancel();
                Toast.makeText(HXBasicLinkInfoActivity.this, "贷款工作流失败", Toast.LENGTH_SHORT).show();
            }
        });
    }
