 ...
 *常见问题页面
 */
public class XJCommonProblemActivity extends XJBaseActivity implements OnClickListener {
			...
			public void onCheckedChanged(RadioGroup arg0, int checkId) {
				...
				case R.id.common_problem_zhenxin_btn:
					//征信相关
					 ...
					 adapter=new HXCommonProblemListAdapter(XJCommonProblemActivity.this, zhengxinProblem);
					 mProblemListView.setAdapter(adapter);
					break;
				case R.id.common_problem_hetong_btn:
					//合同条款
					isZhengxinProblem=false;
					adapter=new HXCommonProblemListAdapter(XJCommonProblemActivity.this, hetongProblem);
				    mProblemListView.setAdapter(adapter);
					break;
	...
	public void onClick(View view) {
		...
		case R.id.left_btn:
			//返回
			XJCommonProblemActivity.this.finish();
			break;
		case R.id.common_problem_zhenxin_btn:
			//征信相关
