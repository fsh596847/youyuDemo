...
public class XJSetPayPassWordActivity extends XJBaseActivity implements OnClickListener {
...
//	private String cell;
	private Handler handler = new Handler(){
		public void dispatchMessage(Message msg) {
			...
			if(msg.what == 0){
				intent = new Intent(XJSetPayPassWordActivity.this,XJSetPayPassWordActivity2.class);
...
//		}
	...
	private void initViews() {
		...
		if (mPwdEt != null) {
			keyboard.setRecvTouchEventActivity(XJSetPayPassWordActivity.this);
		}
		mPwdEt.setOnEditTextContentListener(new JYPEditText.EditTextContentListener() {
			...
			public void onComplete(CharSequence text) {
				...
				//				Intent intent = new Intent(XJSetPayPassWordActivity.this,XJSetBankCardPwdAgainActivity.class);
				//				intent.putExtra("password",password);
				//				startActivity(intent);
				//				XJSetPayPassWordActivity.this.finish();
	...
	protected void changePayPwd(String password,String password2){
		...
		ApplicationExtension.instance.dataHttp.send(HttpMethod.POST,
			...
			public void onFailure(HttpException arg0, String error) {
				...
				Toast.makeText(XJSetPayPassWordActivity.this, "error = " + error,Toast.LENGTH_SHORT).show();
				XJSetPayPassWordActivity.this.finish();
			}
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				if (responseInfo.statusCode == 200) {
					...
					if ("000000".equals(returnCode)) {
						...
						Toast.makeText(XJSetPayPassWordActivity.this, "设置支付密码成功", Toast.LENGTH_SHORT).show();;
					} else {
						LoggerUtil.debug("设置支付密码失败!");
						String returnMsg = resultMap.get("returnMsg");// 错误提示
						Toast.makeText(XJSetPayPassWordActivity.this, returnMsg,Toast.LENGTH_SHORT).show();
