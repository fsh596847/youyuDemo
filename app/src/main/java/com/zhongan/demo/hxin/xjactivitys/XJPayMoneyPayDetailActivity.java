 ...
 * 全额、分期还款详情界面
 */
public class XJPayMoneyPayDetailActivity extends XJBaseActivity implements
		OnClickListener {
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case Contants.MSG_DO_SUBMIT_DELAY_PAY_MONEY_SUCCESS:
			    ...
			    Intent intent = new Intent(XJPayMoneyPayDetailActivity.this,XJPayMoneyResultActivity.class);
				intent.putExtra("flag", "true");
				intent.putExtra("payType",payType);
				intent.putExtra("loanId",loanId);
				startActivity(intent);
				XJPayMoneyPayDetailActivity.this.finish();
			...
			case Contants.MSG_DO_SUBMIT_DELAY_PAY_MONEY_FAILURE:
				...
				mSubmitBtn.setClickable(true);
			    mSubmitBtn.setBackgroundResource(R.drawable.hxcommon_btn_normal_bg);
			    Intent fauilerIntent = new Intent(XJPayMoneyPayDetailActivity.this,XJPayMoneyResultActivity.class);
...
//				
//  								Gson gson = new Gson();
//  								BankListBean bankListData= gson.fromJson(responseInfo.result, BankListBean.class);//还款计划数据
//                              
//								String returnCode = bankListData.getReturnCode();//返回交易吗
//  								if ("000000".equals(returnCode)) 
//  								{
//  									List<BankListItemBean> bankList=bankListData.getBankList();
//  									LoggerUtil.debug("卡列表---->"+bankList);
//  									String bankNoStr=bankList.get(0).getBankCode();
//  									String bankNo=bankNoStr.substring( bankNoStr.length()-4, bankNoStr.length());
//  									mPayTypeTv.setText(bankList.get(0).getBankName()+"  储蓄卡   "+bankNo);
...
//				R.layout.zhiwen_password_pop_layout, null);
...
//						XJPayMoneyPayDetailActivity.this);
...
//										XJPayMoneyPayDetailActivity.this,
//										XJPayMoneyResultActivity.class);
...
//	}
	...
	private void initPasswordPopWindow() {
		...
		if (mPwdEt != null) {
            keyboard.setRecvTouchEventActivity(XJPayMoneyPayDetailActivity.this);
        }
