 ...
 * 借款列表页面
 */
public class XJPayMoneyListActivity extends XJBaseActivity implements
		OnClickListener {
		...
		mRefreshListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				if (datas != null && datas.size() != 0) {
					...
					Intent intent = new Intent(XJPayMoneyListActivity.this,
...
//				});
	...
	public void onClick(View view) {
		...
		case R.id.left_btn:
			// 返回
			XJPayMoneyListActivity.this.finish();
			break;
