...
public class HXBasicLinesListAdapter extends BaseAdapter {
	private Context context;
	private int[] picData;
	private String[] titles;

	public HXBasicLinesListAdapter(Context context, String[] titles) {
		super();
	...
	public View getView(final int position, View view, ViewGroup container) {
		...
		if (view == null) {
			...
			view =  LayoutInflater.from(context).inflate(
					R.layout.hxall_lines_pop_list_item_layout, null);
