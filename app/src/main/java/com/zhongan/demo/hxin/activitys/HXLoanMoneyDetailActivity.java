 ...
 * 借款详情界面
 */
public class HXLoanMoneyDetailActivity extends HXBaseActivity implements OnClickListener
{
	...
	public void onClick(View view) {
		...
		case R.id.left_btn:
			//返回
			HXLoanMoneyDetailActivity.this.finish();
			break;
		case R.id.pay_money_look_hetong_tv:
			String contractURL=loanItem.getContractUrl();
			Intent useLinesIntent=new Intent(HXLoanMoneyDetailActivity.this,HXUserLineActivity.class);
