...
public class JYPEditText extends EditText implements Animation.AnimationListener{
     ...
     * 四周倒角半径
     */
    private float chamferRadius = 10f;
     ...
     * 控制边框线颜色
     */
    private String lineColor = "#738cc4";
    ...
    public JYPEditText(Context context) {
        this(context,null);
    }

    public JYPEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public JYPEditText(Context context, AttributeSet attrs) {
        ...
        for(InputFilter filter : filters) {
            if("android.text.InputFilter.LengthFilter".equals(filter.getClass().getCanonicalName())) {
                try {
                    ...
                    //获取字段值
                    int num = (Integer) mMax.get(filter);
                    return num;
                } catch (Exception e) {
                }
	...
	public void setFirstComplete(boolean isFirstComplete) {
