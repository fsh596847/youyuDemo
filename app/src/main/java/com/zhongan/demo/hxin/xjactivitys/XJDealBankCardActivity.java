 ...
 * 银行卡验证、添加页面
 */
public class XJDealBankCardActivity extends XJBaseActivity implements
        OnClickListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Contants.MSG_CHECK_BNAK_CARD_INFO_SUCCESS:
                    Intent submitIntent = new Intent(XJDealBankCardActivity.this,
                            XJSetBankCardPwdActivity.class);
...
//                    Intent intent = new Intent(XJDealBankCardActivity.this,
//                            XJDealResultActivity.class);
...
//                openName = sharePrefer.getUserName();
...
//                openIdcard = sharePrefer.getIdCardNum();
        ...
        public void afterTextChanged(Editable text) {
            ...
            if (option.equals("checkThree")) {
                ...
                if (openName != null && !openName.equals("") && openCardId != null && !openCardId.equals("") && openCardId.length() > 10 && openCardId.length() <= 19) {
                    ...
                    String nameOfBank = AssetsBankInfo.getNameOfBank(XJDealBankCardActivity.this, sixNum);//获取银行卡的信息
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.left_btn:
                // 返回
			XJDealBankCardActivity.this.finish();
//			intent.putExtra("flag",0);//0：返回首页 2：返回我的账户
                /*Intent intent = new Intent(XJDealBankCardActivity.this, XJMainActivity.class);
                startActivity(intent);*/
                break;
...
//				mHandler.sendMessage(msg);
                    Toast toast =  Toast.makeText(XJDealBankCardActivity.this, "手机号码不能为空!", Toast.LENGTH_SHORT);
...
//						msg.obj = "请输入6位合法验证码!";
//						mHandler.sendMessage(msg);
                            Toast.makeText(XJDealBankCardActivity.this, "请输入6位合法验证码!", Toast.LENGTH_SHORT).show();
...
//					mHandler.sendMessage(msg);
                        Toast.makeText(XJDealBankCardActivity.this, "请输入11位合法手机号码!", Toast.LENGTH_SHORT).show();
                        mMoblieEt.setAnimation(Util.shakeAnimation(10));
                        return;
                    }
    ...
    private void getLinesURL(final String[] titles, final int position) {
        ...
        httpRequest(Contants.REQUEST_URL, params, new ResultCallBack() {
            ...
            public void onSuccess(String data) {
                ...
                Intent intent = new Intent(XJDealBankCardActivity.this, XJUserLineActivity.class);
