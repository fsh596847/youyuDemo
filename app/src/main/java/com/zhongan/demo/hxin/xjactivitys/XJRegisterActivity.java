 ...
 * 注册页面
 */
public class XJRegisterActivity extends XJBaseActivity implements OnClickListener {
...
//				mYzmBtn.setClickable(true);
			...
			case Contants.MSG_REGISTER_SUCCESS:
				mdialog.cancel();
				Toast.makeText(XJRegisterActivity.this,"注册成功!",1).show();
				sharePrefer.setPhone(mobile);
				Intent registerIntent=new Intent(XJRegisterActivity.this,XJLoginActivity.class);
	            startActivity(registerIntent);
	            XJRegisterActivity.this.finish();
				break;
			case Contants.MSG_REGISTER_FAILURE:
				mdialog.cancel();
				String errorMsg = (String) msg.obj;
				mErrorTv.setText(errorMsg);
				Toast.makeText(XJRegisterActivity.this,"注册失败!",1).show();
//				mYzmEt.setText("");
//				timer.cancel();
//				mYzmBtn.setText(R.string.yzm_btn_text);
//				mYzmBtn.setTextColor(getResources().getColor(R.color.color_ff7920));
//				mYzmBtn.setClickable(true);
	...
	private void initViews() {
		mMobileEt = (EditText) findViewById(R.id.register_phone_et);
		mPasswordEt = (EditText) findViewById(R.id.register_password_et);
		mYzmEt = (EditText) findViewById(R.id.register_yzm_et);
		mErrorTv = (TextView) findViewById(R.id.register_error_tv);
		mRegisterBtn = (Button) findViewById(R.id.register_btn);
		mLoginBtn = (Button) findViewById(R.id.register_go_login_btn);
		mHasProblemBtn = (Button) findViewById(R.id.register_has_problem_btn);
		mYzmBtn = (Button) findViewById(R.id.register_yzm_btn);
...
//				register(mobile,password);
		...
		case R.id.register_go_login_btn:
			mErrorTv.setText("");
			//登录
//			Intent loginIntent=new Intent(XJRegisterActivity.this,XJLoginActivity.class);
//            startActivity(loginIntent);
		...
		case R.id.register_tip_two:
			...
			Intent useLinesIntent=new Intent(XJRegisterActivity.this,XJUserLineActivity.class);
