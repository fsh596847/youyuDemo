 ...
 * 借还记录页面
 */
public class HXLoanPayRecordListActivity extends HXBaseActivity implements
        OnClickListener {
		...
		mRecordRg.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup arg0, int checkId) {
				...
				case R.id.pay_record_btn:
					...
					loadData(Contants.MSG_REFRESH_DATA_SUCCESS);
					// payAdapter=new
					// HXPayRecordPayListAdapter(HXLoanPayRecordListActivity.this,
					// payListData);
				...
				if (isLoanRecord) {
					if (LoanRecordDatas != null && LoanRecordDatas.size() != 0) {
						...
						Intent intent = new Intent(
								HXLoanPayRecordListActivity.this,
...
//									// 列表不存在
//									List<HXPayMoneyRecordListItemBean> resultList = new ArrayList<HXPayMoneyRecordListItemBean>();
//									Message msg = new Message();
//									msg.what = what;
//									Bundle bundle = new Bundle();
//									bundle.putSerializable("data",
...
//					});
	...
	public void onClick(View view) {
		...
		case R.id.left_btn:
			// 返回
			HXLoanPayRecordListActivity.this.finish();
			break;
		case R.id.loan_record_btn:
			// 借款记录
