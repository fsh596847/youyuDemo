 ...
 * 忘记密码页面
 */
public class XJForgetPwdActivity extends XJBaseActivity implements OnClickListener {
	...
	private void getMsmCode(int isNo, String mobile) {
		...
		httpRequest(Contants.REQUEST_URL, params, new ResultCallBack() {
			...
			public void onError(String returnCode, String msg) {
				// TODO Auto-generated method stub
				Toast.makeText(XJForgetPwdActivity.this,msg, Toast.LENGTH_SHORT).show();
				mHandler.sendEmptyMessage(0);
			}
		});
...
//						msg.obj = "";
//						Toast.makeText(XJForgetPwdActivity.this,"获取验证码失败", Toast.LENGTH_SHORT).show();
...
//								Toast.makeText(XJForgetPwdActivity.this,returnMsg, Toast.LENGTH_SHORT).show();
//								Message msg = new Message();
//								msg.what = Contants.MSG_GET_YZM_CODE_FAILURE;
//								msg.obj = returnMsg;
//								mHandler.handleMessage(msg);
...
//				});
	...
	public void onClick(View view) {
		...
		case R.id.left_btn:
			// 返回
			XJForgetPwdActivity.this.finish();
			break;
...
//				mHandler.handleMessage(msg);
	...
	private void chanegLoginPwd() {
		...
		if(Util.passwordMatcher(pwd1)){
			Toast.makeText(XJForgetPwdActivity.this, "密码不符合规则", Toast.LENGTH_SHORT).show();
			return;
		}
        ...
        httpRequest(Contants.REQUEST_URL, params, new ResultCallBack() {
			...
			public void onSuccess(String data) {
				...
				Toast.makeText(XJForgetPwdActivity.this, "修改密码成功", Toast.LENGTH_SHORT).show();
				startActivity(new Intent(XJForgetPwdActivity.this,XJLoginActivity.class));
				XJForgetPwdActivity.this.finish();
			}
...
//								Toast.makeText(XJForgetPwdActivity.this, "修改密码失败", Toast.LENGTH_SHORT).show();
//								String returnMsg = resultMap.get("returnMsg");// 错误提示
////								Message msg = new Message();
////								msg.what = Contants.MSG_GET_YZM_CODE_FAILURE;
////								msg.obj = returnMsg;
