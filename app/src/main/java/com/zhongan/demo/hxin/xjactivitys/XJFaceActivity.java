 ...
 **/
@SuppressLint("NewApi")
public class XJFaceActivity extends XJBaseActivity
	...
	private void handleStart() {
		...
		isHandleStart = true;
		// 开始动画
		Animation animationIN = AnimationUtils.loadAnimation(XJFaceActivity.this, R.anim.face_liveness_rightin);
		Animation animationOut = AnimationUtils.loadAnimation(XJFaceActivity.this, R.anim.face_liveness_leftout);
	...
	//活体检测接口
		private void checkFace(final String phone,String faceimage,String delta)
		{
			 ...
			 params.addBodyParameter("cell",sharePrefer.getPhone());//手机号
