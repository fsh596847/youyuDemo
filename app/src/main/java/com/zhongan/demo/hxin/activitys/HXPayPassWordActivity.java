...
//支付密码/登录密码设置
public class HXPayPassWordActivity extends HXBaseActivity implements OnClickListener {
	...
	public void onClick(View view) {
		...
		case R.id.change_pay_password:
			// 修改支付密码
			intent = new Intent(this,HXChangePayPassWordActivity.class);
			startActivity(intent);
			break;

		case R.id.forget_pay_password:
			// 忘记支付密码
			intent = new Intent(this,HXForgetPayPassWordActivity.class);
			startActivity(intent);
			break;
