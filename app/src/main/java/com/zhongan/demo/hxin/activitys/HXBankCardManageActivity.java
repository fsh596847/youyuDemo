 ...
 * 银行卡管理页面
 */
public class HXBankCardManageActivity extends HXBaseActivity implements
        OnClickListener {
	...
	public static HXBankCardManageActivity instance;
...
//							Gson gson = new Gson();
//							HXBankListBean bankListData = gson.fromJson(
//									responseInfo.result, HXBankListBean.class);// 还款计划数据
//
//							String returnCode = bankListData.getReturnCode();// 返回交易吗
//							if ("000000".equals(returnCode)) {
//								List<HXBankListItemBean> bankList = bankListData
//										.getBankList();
//								LoggerUtil.debug("卡列表---->" + bankList);
//								Bundle bundle = new Bundle();
//								bundle.putSerializable("bankList",
...
//				});
	...
	public void onClick(View view) {
		...
		case R.id.left_btn:
			// 返回
			HXBankCardManageActivity.this.finish();
			break;
		case R.id.right_btn:
			// 添加银行卡
			Intent addIntent = new Intent(HXBankCardManageActivity.this,
					HXDealBankCardActivity.class);
