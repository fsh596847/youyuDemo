 ...
 * 实名验证页面
 */
public class XJTrueNameActivity extends XJBaseActivity implements OnClickListener {
...
//		
	...
	public void onClick(View view) {
		...
		case R.id.left_btn:
			//返回
			XJTrueNameActivity.this.finish();
			break;
		case R.id.true_name_not_check_fl:
			//未实名认证展示布局
			//身份证上传
			Intent upoadIntent=new Intent(XJTrueNameActivity.this,XJFaceIDCardInfoUploadActivity.class);
