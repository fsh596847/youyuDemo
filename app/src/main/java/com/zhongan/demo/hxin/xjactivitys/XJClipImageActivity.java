 ...
 * 头像裁剪Activity
 */
public class XJClipImageActivity extends XJBaseActivity implements View.OnClickListener {
	private View mStatusView;//设置顶部标题栏距手机屏幕顶部距离为状态栏高度，防止状态栏遮挡
	private Button mBackBtn;//返回按钮
	private TextView mTitleView;//标题
    private static final String TAG = "XJClipImageActivity";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.left_btn:
            	XJClipImageActivity.this.finish();
                break;
