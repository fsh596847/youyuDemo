 ...
 * 设置交易密码页面
 */
public class XJSetBankCardPwdAgainActivity extends XJBaseActivity implements OnClickListener {
    ...
    private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case Contants.MSG_SET_JIAOYI_PWD_SUCCESS:
				Intent intent = new Intent(XJSetBankCardPwdAgainActivity.this,XJDealResultActivity.class);
				intent.putExtra("checkResult","success");//验证结果：成功 success 失败failure
				startActivity(intent);
				XJSetBankCardPwdAgainActivity.this.finish();
				break;
			case Contants.MSG_SET_JIAOYI_PWD_FAILURE:
				String errorMsg=(String) msg.obj;
				Intent errorIntent = new Intent(XJSetBankCardPwdAgainActivity.this,XJDealResultActivity.class);
			...
			case Contants.MSG_DO_CHECK_PWD_DIFFRIENT_FAILURE:
				CustomDialog.Builder builder = new CustomDialog.Builder(
						XJSetBankCardPwdAgainActivity.this);
...
//		 mPwdEt.setFirstComplete(false);
		 ...
		 if (mPwdEt != null) {
	            keyboard.setRecvTouchEventActivity(XJSetBankCardPwdAgainActivity.this);
	     }
