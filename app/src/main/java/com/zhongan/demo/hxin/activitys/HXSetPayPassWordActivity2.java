...
public class HXSetPayPassWordActivity2 extends HXBaseActivity implements OnClickListener {
...
//		}
	...
	private void initViews() {
		...
		if (mPwdEt != null) {
			keyboard.setRecvTouchEventActivity(HXSetPayPassWordActivity2.this);
		}
	...
	public void onClick(View view) {
		...
		case R.id.left_btn:
			//返回
			HXSetPayPassWordActivity2.this.finish();
			break;
		default:
			break;
		}
	...
	private void passwordModify(String password, String password2){
			...
			httpRequest(Contants.REQUEST_URL, params, new ResultCallBack() {
				...
				public void onSuccess(String data) {
					...
					//Toast.makeText(HXSetPayPassWordActivity2.this, "忘记支付密码成功!", Toast.LENGTH_SHORT).show();
					setResult(RESULT_OK);
					HXSetPayPassWordActivity2.this.finish();
				}
	...
	protected void changePayPwd(String password, String password2){
		...
		params.addQueryStringParameter("telphone", getSharePrefer().getPhone());
		...
		httpRequest(Contants.REQUEST_URL, params, new ResultCallBack() {
			...
			public void onSuccess(String data) {
				// TODO Auto-generated method stub
				mdialogProgress.dismiss();
				//Toast.makeText(HXSetPayPassWordActivity2.this, "修改支付密码成功!", Toast.LENGTH_SHORT).show();
                ToastUtils.showCenterToast("修改支付密码成功" ,HXSetPayPassWordActivity2.this);
				setResult(RESULT_OK);
				HXSetPayPassWordActivity2.this.finish();
			}
			...
			public void onFailure(HttpException exception, String msg) {
				// TODO Auto-generated method stub
				mdialogProgress.dismiss();
//				Toast.makeText(HXSetPayPassWordActivity2.this, "error = " + error,Toast.LENGTH_SHORT).show();
				setResult(RESULT_OK);
				HXSetPayPassWordActivity2.this.finish();
			}
			...
			public void onError(String returnCode, String returnMsg) {
				// TODO Auto-generated method stub
				mdialogProgress.dismiss();
//				Toast.makeText(HXSetPayPassWordActivity2.this, returnMsg,Toast.LENGTH_SHORT).show();
				setResult(RESULT_OK);
				HXSetPayPassWordActivity2.this.finish();
			}
		});
...
//						Toast.makeText(HXSetPayPassWordActivity2.this, "设置支付密码成功", Toast.LENGTH_SHORT).show();;
//					} else {
