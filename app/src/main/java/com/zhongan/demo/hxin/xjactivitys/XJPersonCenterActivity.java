...
public class XJPersonCenterActivity extends XJBaseActivity implements OnClickListener
{
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case Contants.MSG_DO_QUERY_IDCARD_INFO_FAILURE:
				CustomDialog.Builder builder = new CustomDialog.Builder(XJPersonCenterActivity.this);
	...
	private void initViews()
	{
		...
		String hideMoblie=Util.hideMobile(sharePrefer.getPhone());
		...
		if("ced".equals(userStateInfo)
				||"loaned".equals(userStateInfo)
				||"face++".equals(userStateInfo)) {
			mAccountSafeFl.setVisibility(View.VISIBLE);
		}else {
			mAccountSafeFl.setVisibility(View.INVISIBLE);
		}
	...
	public void onClick(View view) {
		...
		case R.id.person_center_back_btn:
			XJPersonCenterActivity.this.finish();
			break;
...
//			mPopWindow.showAtLocation(view, 0, 0, 0);
		...
		case R.id.person_center_true_name_fl:
			//实名认证
			Intent trueNameIntent=new Intent(XJPersonCenterActivity.this,XJTrueNameActivity.class);
		...
		case R.id.person_center_idcard_img_upload_fl:
			//身份证上传
//			Intent upoadIntent=new Intent(XJPersonCenterActivity.this,XJFaceIDCardInfoUploadActivity.class);
//			upoadIntent.putExtra("option","centerUpload");
//			startActivity(upoadIntent);
			break;
		case R.id.person_center_accound_safe_fl:
			//账户安全
			Intent accountIntent=new Intent(XJPersonCenterActivity.this,XJAccountSafeActivity.class);
	...
	private void logout()
	{
		...
		httpRequest(Contants.REQUEST_URL, params, new ResultCallBack() {
			...
			public void onSuccess(String data) {
				...
				Toast.makeText(XJPersonCenterActivity.this,"登出成功!",Toast.LENGTH_SHORT).show();
				Intent logoutIntent=new Intent(XJPersonCenterActivity.this,XJLoginActivity.class);
...
//						Toast.makeText(XJPersonCenterActivity.this,"网络问题!",Toast.LENGTH_SHORT).show();
//					}
//
//					@Override
...
//							else
//							{
//								Toast.makeText(XJPersonCenterActivity.this,"returnMsg",Toast.LENGTH_SHORT).show();
////								String returnMsg = resultMap.get("returnMsg");// 错误提示
////								Message msg = new Message();
////								msg.what = Contants.MSG_DO_QUERY_IDCARD_INFO_FAILURE;
////								msg.obj = returnMsg;
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				if (position == (titles.length - 1)) {
					...
					//拍照
					 //权限判断
//	                if (ContextCompat.checkSelfPermission(XJPersonCenterActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
//	                        != PackageManager.PERMISSION_GRANTED) {
//	                    //申请WRITE_EXTERNAL_STORAGE权限
//	                    ActivityCompat.requestPermissions(XJPersonCenterActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
...
//	                }
				...
				}else if(position==1)
				{
					//相册选取
					 //权限判断
//	                if (ContextCompat.(XJPersonCenterActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
//	                        != PackageManager.PERMISSION_GRANTED) {
//	                    //申请READ_EXTERNAL_STORAGE权限
//	                    ActivityCompat.requestPermissions(XJPersonCenterActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
...
//	                }
        ...
        switch (requestCode) {
            ...
            case REQUEST_CROP_PHOTO:  //剪切图片返回
                if (resultCode == RESULT_OK) {
                    ...
                    sharePrefer.setCropImagePath(cropImagePath);//存储头像图片路径
    ...
    public void gotoClipActivity(Uri uri) {
        ...
        intent.setClass(this, XJClipImageActivity.class);
