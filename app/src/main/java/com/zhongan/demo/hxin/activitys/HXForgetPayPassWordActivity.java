...
public class HXForgetPayPassWordActivity extends HXBaseActivity implements OnClickListener {
...
//						HXForgetPayPassWordActivity.this);
...
//	};
	...
	public void onClick(View view) {
		...
		case R.id.left_btn:
			...
			HXForgetPayPassWordActivity.this.finish();
			break;
...
//			startActivity(intent);
	...
	private void checkNum() {
		...
		if(TextUtils.isEmpty(id_num_edit.getText()) || !Util.isIdCardNum(id_num_edit.getText().toString())){
            ...
            ToastUtils.showCenterToast("请输入正确的身份证号" ,this);
			return;
		}
		
		if(TextUtils.isEmpty(register_yzm_et.getText())){
			//Toast.makeText(this, "请输入验证码", Toast.LENGTH_SHORT).show();
            ToastUtils.showCenterToast("请输入验证码" ,this);
			return;
		}
		
		if(!getSharePrefer().getIdCardNum().equals(id_num_edit.getText().toString())){
		...
		params.addQueryStringParameter("clientToken", getSharePrefer().getToken());
		params.addQueryStringParameter("certNo", certNo);
		params.addQueryStringParameter("mobilePhone", getSharePrefer().getPhone());// 手机号码
		...
		httpRequest(Contants.REQUEST_URL, params, new ResultCallBack() {
			...
			public void onSuccess(String data) {
				...
				//Toast.makeText(HXForgetPayPassWordActivity.this, "身份证验证成功", Toast.LENGTH_SHORT).show();
                ToastUtils.showCenterToast("身份证验证成功" ,HXForgetPayPassWordActivity.this);
				intent = new Intent(HXForgetPayPassWordActivity.this,HXSetPayPassWordActivity.class);// HXSetBankCardPwdActivity HXSetPayPassWordActivity
				startActivity(intent);
				HXForgetPayPassWordActivity.this.finish();
			}
...
//						
//					} else {
//						Toast.makeText(HXForgetPayPassWordActivity.this, "身份证验证失败", Toast.LENGTH_SHORT).show();
