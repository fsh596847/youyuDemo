...
public class RefreshSwipeMenuListView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        ...
        mHeaderViewContent = (RelativeLayout) mHeaderView.findViewById(R.id.swipe_refresh_listview_header_content);
        //        mHeaderTimeView = (TextView) mHeaderView.findViewById(R.id.xlistview_header_time);
        addHeaderView(mHeaderView);
        setHeaderDividersEnabled(false);

        // 初始化尾部视图
        mFooterView = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.hxswipe_refresh_listview_footer, null, false);
        ...
        mFooterChrysanthemumIv = (ImageView) mFooterView.findViewById(R.id.swipe_refresh_footer_chrysanthemum);
