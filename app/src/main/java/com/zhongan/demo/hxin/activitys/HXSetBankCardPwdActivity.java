 ...
 * 设置交易密码页面
 */
public class HXSetBankCardPwdActivity extends HXBaseActivity implements OnClickListener {
	...
	private Handler handler = new Handler(){
		public void dispatchMessage(Message msg) {
			...
			if(msg.what == 0){
				Intent intent = new Intent(HXSetBankCardPwdActivity.this,HXSetBankCardPwdAgainActivity.class);
...
//		 mPwdEt.setFirstComplete(false);
		 ...
		 if (mPwdEt != null) {
	            keyboard.setRecvTouchEventActivity(HXSetBankCardPwdActivity.this);
	     }
		 mPwdEt.setOnEditTextContentListener(new JYPEditText.EditTextContentListener() {
			...
			public void onComplete(CharSequence text) {
				...
				keyboard.clearInput();
//				mPwdEt.setFirstComplete(false);
//				HXSetBankCardPwdActivity.this.finish();
//				
			}
		});
	}
