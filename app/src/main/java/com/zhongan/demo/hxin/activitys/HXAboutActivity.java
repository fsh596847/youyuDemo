 ...
 *关于页面
 */
public class HXAboutActivity extends HXBaseActivity implements OnClickListener {
	...
	private void initViews() {
		 ...
		 mAboutListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                                    long arg3) {
				// TODO Auto-generated method stub
				//Toast.makeText(HXAboutActivity.this, aboutList.get(position).get("title"), 1).show();
			}
		});
