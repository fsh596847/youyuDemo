...
public class HXLoanMoneyPaytypeListAdapter extends BaseAdapter {
	private Context context;
	private List<HXPayTypeItemBean> datas;

	public HXLoanMoneyPaytypeListAdapter(Context context, List<HXPayTypeItemBean> datas) {
		super();
	...
	public View getView(final int position, View view, ViewGroup container) {
		...
		if (view == null) {
			...
			view =  LayoutInflater.from(context).inflate(
					R.layout.hxloan_money_pay_type_list_item_layout, null);
		...
		HXPayTypeItemBean item=datas.get(position);
