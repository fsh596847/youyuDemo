 ...
 *借款结果页面
 */
public class HXLoanMoneyResultActivity extends HXBaseActivity implements OnClickListener {
...
//			ActivityStackManagerUtils.getInstance().finishAllActivity();
			Intent intent = new Intent(HXLoanMoneyResultActivity.this,MenuListActivity2.class);
