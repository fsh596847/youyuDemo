...
import com.zhongan.demo.hxin.activitys.HXLoginActivity;
...
public class HXBaseActivity extends ParentActivity {

  protected static final String TAG = "HXBaseActivity";

  private SharedPreferenceUtils sharePrefer;
  ...
  protected SharedPreferenceUtils getSharePrefer() {
    if (null == sharePrefer) {
      sharePrefer = new SharedPreferenceUtils(this.getApplicationContext());
    }
    return sharePrefer;
  ...
  public void httpRequest(String url, RequestParams params, final ResultCallBack callBack) {
    LoggerUtil.debug(TAG, "-----88-url-------" + url);
    params.addBodyParameter("legalPerNum", "00006");// 法人编号

    MyApplication.instance.dataHttp.send(HttpMethod.POST, url, params,
        new RequestCallBack<String>() {
          @Override public void onFailure(HttpException arg0, String arg1) {
            if (callBack != null) {
              //Toast.makeText(HXBaseActivity.this, "网络通信异常", Toast.LENGTH_SHORT).show();
              ToastUtils.showCenterToast("网络通信异常", HXBaseActivity.this);
          ...
          @Override public void onSuccess(ResponseInfo<String> responseInfo) {
            if (responseInfo != null && responseInfo.result != null) {
              ...
              try {
                ...
                LoggerUtil.debug(TAG, "returnCode-------------->"
                    + returnCode
                    + "\nreturnMsg------------->"
                    + returnMsg);
                if ("000000".equals(returnCode)) {
                  ...
                  //Toast.makeText(HXBaseActivity.this, returnMsg, Toast.LENGTH_SHORT).show();
                  ToastUtils.showCenterToast(returnMsg, HXBaseActivity.this);
                  if (!sharePrefer.iSLogin()) {

                    Intent intent = new Intent(HXBaseActivity.this, LoginActivity.class);
                ...
                //Toast.makeText(HXBaseActivity.this, "数据异常", Toast.LENGTH_SHORT).show();
                ToastUtils.showCenterToast("数据异常", HXBaseActivity.this);
              }
            }
          }
