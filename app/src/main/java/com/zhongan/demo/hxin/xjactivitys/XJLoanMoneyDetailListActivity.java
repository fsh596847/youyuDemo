 ...
 * 借款详情列表页面
 */
public class XJLoanMoneyDetailListActivity extends XJBaseActivity implements
		OnClickListener {
		...
		public void handleMessage(Message msg) {
			...
			case Contants.MSG_DO_AHEAD_PAY_MONEY_FAILURE:
				...
				CustomDialog.Builder builder = new CustomDialog.Builder(
						XJLoanMoneyDetailListActivity.this);
...
//							Gson gson = new Gson();
//							LoanMoneyDetailListBean resultData = gson.fromJson(
//									responseInfo.result,
//									LoanMoneyDetailListBean.class);
...
//										.debug("借款详情列表 overDaysFlag----------->"
//												+ overDaysFlag);
//								List<LoanMoneyDetailListItemBean> resultList = resultData
//										.getRows();
...
//
//								// 列表不存在
//								List<LoanMoneyDetailListItemBean> resultList = new ArrayList<LoanMoneyDetailListItemBean>();
//								Message msg = new Message();
//								msg.what = Contants.MSG_LOAN_MONEY_DETAIL_LIST_SUCCESS;
//								Bundle bundle = new Bundle();
//								bundle.putSerializable("data",
...
//				});
	...
	public void onClick(View view) {
		...
		case R.id.left_btn:
			// 返回
			XJLoanMoneyDetailListActivity.this.finish();
			break;
...
//					String repayFee=resultMap.get("repayFee");//费用金额
					...
					Intent intent = new Intent(
							XJLoanMoneyDetailListActivity.this,
							XJPayMoneyPayDetailActivity.class);
					Bundle bundle = new Bundle();
...
//								
//								Gson gson = new Gson();
//								PayAllMoneyListBean resultMap = gson.fromJson(responseInfo.result, PayAllMoneyListBean.class);
