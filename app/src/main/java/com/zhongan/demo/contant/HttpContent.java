...
public interface HttpContent {
  //请求接口根地址
  String BASE_URL = "http://api-core.rskj99.com/rskj-core-api";//生产
  //    public static final String BASE_URL = "http://test.rskj99.com/rskj-core-api";//测试
  ...
  //注册协议
  String REGISTER_PROTOCOL = "http://youyuapi.rskj99.com/youyu-api/html/s?n=register_protocol";//生产
  ...
  //帮助中心
  String HELP_CENTER = "http://app-web.rskj99.com/helpcenter/helpcenter.html";

  //关于我们
  String ABOUT_US = "http://app-web.rskj99.com/aboutus/aboutus.html";

  String GET_URL = "http://youyuapi.rskj99.com/youyu-api/SystemConfig/getConfig";
