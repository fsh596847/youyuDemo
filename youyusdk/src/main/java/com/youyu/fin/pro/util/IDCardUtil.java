...
//    }
    ...
    public static byte[] bmp2byteArr(Bitmap bmp) {
        ...
        IDCardUtil.closeStreamSilently(byteArrayOutputStream);
    ...
    public static byte[] readModel(Context context) {
        ...
        int count = -1;
        try {
            inputStream = context.getResources().openRawResource(R.raw.megviiidcard_0_2_0_model);
